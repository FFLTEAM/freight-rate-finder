...
if not origin_coords and not destination_coords:
    ...
    # Generate location strings for geocoding
    df['origin_latlon'] = df['origin_city'] + ", " + df['origin_country']
    df['destination_latlon'] = df['destination_city'] + ", " + df['destination_country']
