...
if uploaded_file is not None:
    try:
        ...
        if not required_columns.issubset(df.columns):
            ...
            df["Origin City"] = df["Origin City"].astype(str).str.strip().str.lower()
            df["Destination City"] = df["Destination City"].astype(str).str.strip().str.lower()
            df["Equipment Type: Name"] = df["Equipment Type: Name"].astype(str).str.strip().str.lower()

            # Group all flatbed types into "flatbed"
