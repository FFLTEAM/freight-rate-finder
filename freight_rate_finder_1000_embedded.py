...
# Generate 1000 random embedded records
cities = [
...
if not origin_coords and not destination_coords:
    ...
    display_cols = ['rate', 'equipment_type', 'origin_city', 'origin_state', 'origin_country', 'destination_city', 'destination_state', 'destination_country', 'distance_miles', 'rate_per_mile', 'service_type']
