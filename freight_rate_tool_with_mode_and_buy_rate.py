...
if uploaded_file is not None:
    try:
        ...
        required_columns = {
            ...
            "Expected Ship Date", "Stops", "Carrier Name", "-Mode Type"
        }
        ...
        if not required_columns.issubset(df.columns):
            ...
            if st.button("🔍 Find Best Carriers"):
                ...
                if matches.empty:
                    ...
                    st.write("Top Matches (with Suggested Buy Rate):")
                    st.dataframe(matches[[
                        "Origin City", "Destination City", "Base Rate",
                        "Suggested Buy Rate", "Profit (Est.)",
                        "Equipment Group", "Carrier Name", "Expected Ship Date"
                    ]])
