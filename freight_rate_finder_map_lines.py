...
# Load preloaded dataset (replace uploader)
df = pd.read_csv("https://raw.githubusercontent.com/openai-sample-data/fake-freight-datasets/main/fake_freight_data_with_latlon.csv")
